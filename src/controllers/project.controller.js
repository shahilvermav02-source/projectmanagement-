...
const getProjects = asyncHandler(async(req,res)=>{
    ...
    return res
          .status(200)
          .json(new  ApiResponse(200,projects,"Projects fetch successfully"));
})
...
const getProjectsById = asyncHandler(async(req,res) =>{
    ...
    if(!project){
        throw new ApiError(404,"Project not foundt");
    }
...
const deleteProjects = asyncHandler(async(req,res)=>{
    ...
    return res
           .status(200)
           .json(new ApiResponse(200,projectt,"Project deleted successfully"));
})
